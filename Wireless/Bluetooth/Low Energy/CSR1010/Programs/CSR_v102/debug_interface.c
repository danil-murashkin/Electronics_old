...
/*----------------------------------------------------------------------------*
 *  NAME
 *      DebugIfWriteUitn8Array
 *
 *  DESCRIPTION
 *      Print out a uint8 array.
 *
 *  PARAMETERS
 *      
 *
 ...
 *      Nothing
 *---------------------------------------------------------------------------*/
void DebugIfWriteCharArray(const uint8* array, uint16 array_lenght)
{
    uint16 i;
    for (i=0; i<array_lenght; i++) DebugWriteChar((char)array[i]);
