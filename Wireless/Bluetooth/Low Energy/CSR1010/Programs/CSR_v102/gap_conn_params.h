 ...
 * requirements.
 */
#define FC_ADVERTISING_INTERVAL_MIN         (200 * MILLISECOND)
#define FC_ADVERTISING_INTERVAL_MAX         (200 * MILLISECOND)
...
#define PREFERRED_SLAVE_LATENCY             0x0002 /* 4 conn_intervals */
